...
arXivのpreprintは、間違いが多いので注意が必要。また、後者も、r-matrixの符号が間違っているように思う
...
## 射影法による求積
Liouville可積分系をLiouville-Arnoldの定理の教えに従って解くのは、大抵の場合難しい。Calogero-Moser模型では、射影法と呼ばれる解法がある。以下、この方法について、天下り的に概要を記述する。
